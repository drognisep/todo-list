...
"notes": [{
	"id": 123,
	"taskID": 1,
	"text": "A note about stuff",
	"created": "2022-12-24T19:49:06.4883081Z",
	"updated": "2022-12-24T19:49:06.4883081Z"
},{
	"id": 234,
	"taskID": null,
	"text": "Another note about stuff",
	"created": "2022-12-24T19:49:11.4883081Z",
	"updated": "2022-12-24T19:49:11.4883081Z"
}]
}`
...
func TestBoltStorage_Import(t *testing.T) {
	...
	_, err = io.Copy(temp, strings.NewReader(_importData))
	require.NoError(t, err)
	...
	notes, err := tstore.getAllNotes()
	assert.NoError(t, err)
	assert.Len(t, notes, 2)
	assert.Equal(t, *notes[0].TaskID, uint64(1))
	assert.Nil(t, notes[1].TaskID)
}
